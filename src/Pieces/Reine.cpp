...
std::vector<Position> Reine::list_all_possible_moves(Board const& board, Position current_position)
{
    ...
    while (is_move_valid(board, (Next_position), getColor()))
    {
        ...
        Next_position = {.x = current_position.x + i, .y = current_position.y};
        i++;
    }
    int      j{1};
    ...
    while (is_move_valid(board, (Next_position2), getColor()))
    {
        ...
        Next_position2 = {.x = current_position.x - j, .y = current_position.y};
        j++;
    }
    int      k{1};
    ...
    while (is_move_valid(board, (Next_position3), getColor()))
    {
        ...
        Next_position3 = {.x = current_position.x, .y = current_position.y - k};
        k++;
    }
    int      l{1};
    ...
    while (is_move_valid(board, (Next_position4), getColor()))
    {
        ...
        Next_position4 = {.x = current_position.x, .y = current_position.y + l};
        l++;
    }
    int      m{1};
    ...
    while (is_move_valid(board, (Next_position5), getColor()))
    {
        ...
        Next_position5 = {.x = current_position.x + m, .y = current_position.y - m};
        m++;
    }
    int      n{1};
    ...
    while (is_move_valid(board, (Next_position6), getColor()))
    {
        ...
        Next_position6 = {.x = current_position.x - n, .y = current_position.y + n};
        n++;
    }
    int      o{1};
    ...
    while (is_move_valid(board, (Next_position7), getColor()))
    {
        ...
        Next_position7 = {.x = current_position.x + o, .y = current_position.y + o};
        o++;
    }
    int      p{1};
    ...
    while (is_move_valid(board, (Next_position8), getColor()))
    {
        ...
        Next_position8 = {.x = current_position.x - p, .y = current_position.y - p};
        p++;
    }
